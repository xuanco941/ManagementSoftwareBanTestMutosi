        ...
        public ItemThongKeNguon(TestNguon testID, List<Models.Nguon> nguon)
        {
            ...
            foreach (var e in nguon)
            {
                if (e.NguonName == TenThietBi.Nguon1)
                {
                    ...
                    ThoiGianTest1.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon2)
                {
                    ...
                    ThoiGianTest2.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon3)
                {
                    ...
                    ThoiGianTest3.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon4)
                {
                    ...
                    ThoiGianTest4.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon5)
                {
                    ...
                    ThoiGianTest5.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon6)
                {
                    ...
                    ThoiGianTest6.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon7)
                {
                    ...
                    ThoiGianTest7.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon8)
                {
                    ...
                    ThoiGianTest8.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon9)
                {
                    ...
                    ThoiGianTest9.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon10)
                {
                    ...
                    ThoiGianTest10.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon11)
                {
                    ...
                    ThoiGianTest11.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon12)
                {
                    ...
                    ThoiGianTest12.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon13)
                {
                    ...
                    ThoiGianTest13.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon14)
                {
                    ...
                    ThoiGianTest14.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon15)
                {
                    ...
                    ThoiGianTest15.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon16)
                {
                    ...
                    ThoiGianTest16.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon17)
                {
                    ...
                    ThoiGianTest17.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon18)
                {
                    ...
                    ThoiGianTest18.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon19)
                {
                    ...
                    ThoiGianTest19.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon20)
                {
                    ...
                    ThoiGianTest20.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon21)
                {
                    ...
                    ThoiGianTest21.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon22)
                {
                    ...
                    ThoiGianTest22.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon23)
                {
                    ...
                    ThoiGianTest23.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon24)
                {
                    ...
                    ThoiGianTest24.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon25)
                {
                    ...
                    ThoiGianTest25.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon26)
                {
                    ...
                    ThoiGianTest26.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon27)
                {
                    ...
                    ThoiGianTest27.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon28)
                {
                    ...
                    ThoiGianTest28.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon29)
                {
                    ...
                    ThoiGianTest29.Text = e.ThoiGianTest.ToString() + " phút";
                ...
                else if (e.NguonName == TenThietBi.Nguon30)
                {
                    ...
                    ThoiGianTest30.Text = e.ThoiGianTest.ToString() + " phút";
