...
namespace ManagementSoftware
{
    public class Common
    {
        ...
        //Connect
        public static string ConnectionString = @"Data Source=DESKTOP-P4IC2M8\SQLEXPRESS;Initial Catalog=ManagementSoftwareBanTestMutosi;User ID=sa;Password=942001xX";
