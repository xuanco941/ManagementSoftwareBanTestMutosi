...
namespace ManagementSoftware.PLCSetting
{
    public class PLCCongTac : PLCMainDB100
    {
        ...
        public async Task<List<Models.CongTacModel.CongTac>> GetData(double addrCT1, double addrCT2, double addrCT3, double addrCT4, double addrCT5, int jig, double err)
        {
            ...
            ct1.Error = ct1.isError == true ? "NG" : Common.NOT_ERROR_STR;
            ...
            ct2.Error = ct2.isError == true ? "NG" : Common.NOT_ERROR_STR;
            ...
            ct3.Error = ct3.isError == true ? "NG" : Common.NOT_ERROR_STR;
            ...
            ct4.Error = ct4.isError == true ? "NG" : Common.NOT_ERROR_STR;
            ...
            ct5.Error = ct5.isError == true ? "NG" : Common.NOT_ERROR_STR;
